...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"id" : "obj-7",
									"items" : [ "res-transform", ",", "SDIF-buffer", ",", "sinusoids~", ",", "decaying-sinusoids~", ",", "resonance-display" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 647.0, 518.5, 100.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 417.0, 171.5, 270.0, 74.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 55.0, 453.5, 75.0, 22.0 ],
									"style" : "default",
									"text" : "startwindow"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 58.0, 439.5, 75.0, 20.0 ],
									"style" : "default",
									"text" : "• start audio"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 194.0, 27.0, 109.0, 48.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 578.0, 518.5, 60.0, 20.0 ],
									"style" : "default",
									"text" : "see also:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 687.5, 548.5, 82.0, 22.0 ],
									"style" : "default",
									"text" : "prepend help"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 687.5, 579.5, 54.0, 22.0 ],
									"style" : "default",
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.0, 98.5, 347.0, 33.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.0, 76.5, 118.0, 20.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.0, 42.0, 152.0, 33.0 ],
									"style" : "",
									"text" : "resonators~"
								}
...
,
									"patching_rect" : [ 273.0, 197.5, 50.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 174.0, 169.5, 24.0, 24.0 ],
									"style" : "default"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 174.0, 235.5, 62.0, 22.0 ],
									"style" : "default",
									"text" : "selector~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 217.0, 197.5, 50.0, 22.0 ],
									"style" : "default",
									"text" : "*~ 100."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 217.0, 169.5, 47.0, 22.0 ],
									"style" : "default",
									"text" : "noise~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 30.0, 232.5, 61.0, 22.0 ],
									"style" : "default",
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 30.0, 260.5, 24.0, 24.0 ],
									"style" : "default"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 30.0, 286.5, 66.0, 22.0 ],
									"style" : "default",
									"text" : "metro 600"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 314.5, 36.0, 22.0 ],
									"style" : "default",
									"text" : "0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 174.0, 495.5, 45.0, 45.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "list" ],
									"patching_rect" : [ 174.0, 465.5, 178.0, 22.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 70.0, 314.5, 92.0, 33.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 273.0, 171.5, 98.0, 20.0 ],
									"style" : "default",
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 64.5, 488.5, 183.5, 488.5 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "float", "" ],
													"patching_rect" : [ 93.0, 281.215515, 40.0, 22.0 ],
													"style" : "default",
													"text" : "t 0.5 l"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 93.0, 185.086212, 79.0, 22.0 ],
													"style" : "default",
													"text" : "route symbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 93.0, 217.129303, 27.0, 22.0 ],
													"style" : "default",
													"text" : "iter"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 93.0, 249.172424, 181.0, 22.0 ],
													"style" : "default",
...
,
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 93.0, 153.043106, 132.0, 22.0 ],
													"saved_object_attributes" : 													{
														"embed" : 1
													}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "" ],
									"patching_rect" : [ 374.0, 69.833328, 43.0, 22.0 ],
									"style" : "default",
									"text" : "t 0.5 s"
								}
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 398.0, 100.666664, 81.0, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 209.0, 66.833328, 160.0, 47.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 209.0, 44.833328, 27.0, 20.0 ],
									"style" : "default",
									"text" : "1..."
								}
