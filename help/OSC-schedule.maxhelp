...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 22.0, 196.0, 203.919876, 19.499023 ],
					"presentation_rect" : [ 30.0, 30.0, 203.919876, 19.499023 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 223.0, 222.0, 49.0 ],
					"style" : "default",
					"text" : ";\r\nmax launch_browser https://github.com/CNMAT/CNMAT-odot"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 159.0, 272.0, 34.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 275.0, 366.0, 141.0, 22.0 ],
					"prefix_mode" : 2,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 336.0, 402.0, 138.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 336.0, 427.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.0, 366.0, 61.0, 20.0 ],
					"style" : "",
					"text" : "See also:"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 206.0, 9.0, 109.0, 48.0 ]
				}
...
,
					"patching_rect" : [ 370.0, 246.870361, 148.0, 22.0 ],
...
,
					"patching_rect" : [ 370.0, 275.259277, 141.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 370.0, 218.481476, 167.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 370.0, 188.740738, 122.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 698.0, 109.0, 227.0, 48.0 ],
									"style" : "default",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 394.0, 82.0, 235.0, 62.0 ],
									"style" : "default",
...
,
					"patching_rect" : [ 371.0, 159.0, 85.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 95.0, 457.0, 48.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 24.0, 175.0, 34.0 ],
					"style" : "",
					"text" : "OSC-schedule"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 69.0, 457.0, 20.0 ],
					"style" : "default",
