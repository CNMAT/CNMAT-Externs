...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 47.0, 120.0, 233.0, 20.0 ],
									"style" : "default",
									"text" : "more interesting examples in help patch :)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 47.0, 80.0, 275.0, 20.0 ],
									"style" : "default",
									"text" : "support for interpolation of waveguide parameters"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 47.0, 44.0, 63.0, 20.0 ],
									"style" : "default",
									"text" : "TODO list"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 132.0, 316.670349, 104.0, 22.0 ],
									"style" : "",
									"text" : "s waveguide-help"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 246.5, 243.0, 80.0, 22.0 ],
									"style" : "default",
									"text" : "set delay * 3."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 335.5, 243.0, 173.0, 47.0 ],
									"style" : "default",
									"text" : "you can apply a setting to all edges at once using \"*\" instead of the edge number:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 132.0, 164.0, 323.0, 22.0 ],
									"style" : "default",
									"text" : "connect edge 0 0 1 connect edge 1 1 2 connect edge 2 2 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 72.5, 71.0, 442.0, 20.0 ],
									"style" : "default",
									"text" : "waveguide~ can accept any number of commands simultaneously in a list format:"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 127.5, 141.0, 332.0, 20.0 ],
									"style" : "default",
									"text" : "e.g. this sets up a triangle with three edges and three nodes:"
								}
