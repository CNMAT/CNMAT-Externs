...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 547.0, 455.0, 64.0, 22.0 ],
									"style" : "default",
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 641.0, 455.0, 64.0, 22.0 ],
									"style" : "default",
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 641.0, 488.0, 77.0, 22.0 ],
									"style" : "default",
									"text" : "attenuate $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 641.0, 370.0, 25.0, 81.0 ],
									"setminmax" : [ 0.0, 102.0 ],
									"setstyle" : 1,
									"style" : "default"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 547.0, 370.0, 25.0, 81.0 ],
									"setminmax" : [ 0.0, 1.0 ],
									"setstyle" : 1,
									"style" : "default"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 547.0, 488.0, 82.0, 22.0 ],
									"style" : "default",
									"text" : "gain-scale $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 720.0, 488.0, 25.0, 20.0 ],
									"style" : "default",
									"text" : "dB"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 14.0, 46.0, 32.0, 19.0 ],
													"style" : "",
													"text" : "dump"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 14.0, 86.0, 85.0, 19.0 ],
													"style" : "",
													"text" : "s help-transform"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 65.0, 40.0, 155.0, 37.0 ],
													"style" : "",
...
,
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 14.0, 66.0, 40.0, 19.0 ],
													"saved_object_attributes" : 													{
														"embed" : 1
													}
,
