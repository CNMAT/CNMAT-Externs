...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 409.0, 266.0, 133.0, 19.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 74.0, 614.0, 66.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 419.0, 428.0, 161.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 741.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 158.0, 30.0, 109.0, 48.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 79.5, 176.0, 19.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 45.0, 119.0, 33.0 ],
					"style" : "",
					"text" : "gridpanel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 258.0, 614.0, 20.0, 20.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 614.0, 53.0, 21.0 ],
					"style" : "default",
					"text" : "4 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 354.0, 186.0, 20.0, 20.0 ],
					"style" : "default"
				}
...
,
					"patching_rect" : [ 74.0, 643.0, 46.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 74.0, 675.5, 27.0, 53.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 258.0, 133.428574, 53.0, 21.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 258.0, 161.428574, 54.0, 21.0 ],
					"style" : "default"
				}
...
,
					"patching_rect" : [ 419.0, 578.0, 61.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 258.0, 112.428574, 79.0, 19.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 189.428574, 70.0, 21.0 ],
					"style" : "default",
					"text" : "linewidth $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 34.0, 141.428574, 53.0, 21.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 169.428574, 54.0, 21.0 ],
					"style" : "default",
					"text" : "lines $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 166.0, 141.428574, 53.0, 21.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 90.0, 141.428574, 53.0, 21.0 ],
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.0, 169.428574, 74.0, 21.0 ],
					"style" : "default",
					"text" : "ydivisions $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 169.428574, 74.0, 21.0 ],
					"style" : "default",
					"text" : "xdivisions $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 74.0, 266.0, 333.0, 333.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 222.0, 294.0, 362.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 214.0, 82.0, 21.0 ],
					"style" : "default",
					"text" : "idlemousing $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.5, 311.0, 555.5, 108.0 ],
					"style" : ""
				}
