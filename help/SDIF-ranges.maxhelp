...
,
					"patching_rect" : [ 770.0, 201.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.5, 482.0, 59.0, 20.0 ],
					"style" : "default",
					"text" : "see also:"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 92.000061, 481.0, 100.0, 22.0 ],
					"prefix_mode" : 2,
					"style" : "default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.5, 505.0, 138.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.5, 530.0, 53.0, 22.0 ],
					"style" : "default",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 854.0, 423.5, 99.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 778.0, 396.0, 65.0, 22.0 ],
					"style" : "default",
					"text" : "set incand"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.0, 368.5, 83.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 668.0, 230.0, 90.0, 22.0 ],
					"style" : "default",
					"text" : "column-ranges"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 589.666687, 461.0, 114.0, 40.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 468.333374, 461.0, 115.0, 40.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 347.0, 439.0, 47.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.5, 272.0, 34.0, 22.0 ],
					"style" : "default",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 668.0, 201.0, 82.0, 22.0 ],
					"style" : "default",
					"text" : "max-columns"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.5, 310.0, 39.0, 20.0 ],
					"style" : "default",
					"text" : "Misc."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 778.0, 423.5, 49.0, 22.0 ],
					"style" : "default",
					"text" : "version"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 778.0, 368.5, 63.0, 22.0 ],
					"style" : "default",
					"text" : "set mybuf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 778.0, 341.0, 74.0, 22.0 ],
					"style" : "default",
					"text" : "set otherbuf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.5, 348.0, 179.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 22.5, 377.0, 136.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.5, 20.0, 109.0, 48.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.5, 35.0, 152.0, 33.0 ],
					"style" : "",
					"text" : "SDIF-ranges"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.5, 67.0, 235.0, 33.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.5, 151.0, 237.0, 74.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 347.0, 414.0, 383.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.5, 245.0, 247.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.5, 272.0, 207.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 22.5, 311.0, 121.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 347.0, 318.0, 125.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 859.0, 341.0, 74.0, 60.0 ],
					"style" : "default",
