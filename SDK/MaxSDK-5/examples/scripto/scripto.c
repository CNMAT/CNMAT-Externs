...
static t_class *s_scripto_class, *s_scripto_ui_class;

int main(void)
{	
	t_class *c;
		
	c = class_new("scripto", (method)scripto_new, (method)scripto_free, sizeof(t_scripto), 0L, A_GIMME, 0);
	...
	// now we'll register a secret UI object class
	c = class_new("scripto_ui", (method)scripto_ui_new, (method)scripto_ui_free, sizeof(t_scripto_ui), 0L, A_GIMME, 0L);
