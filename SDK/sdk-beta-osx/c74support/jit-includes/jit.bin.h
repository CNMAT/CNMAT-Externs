...
t_jit_err jit_bin_read_header(FILE_REF fd, ulong *version, long *filesize);
t_jit_err jit_bin_read_chunk_info(FILE_REF fd, ulong *ckid, long *cksize);
t_jit_err jit_bin_read_matrix(FILE_REF fd, void *matrix);

t_jit_err jit_bin_write_header(FILE_REF fd, long filesize);
t_jit_err jit_bin_write_matrix(FILE_REF fd, void *matrix);
