{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "freqmax 2000, freqmin 0",
					"fontsize" : 12.0,
					"numinlets" : 2,
					"presentation_rect" : [ 377.0, 16.0, 0.0, 0.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 376.0, 16.0, 141.0, 18.0 ],
					"id" : "obj-17"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "freqmax 22050, freqmin 0",
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 48.0, 147.0, 18.0 ],
					"id" : "obj-15"
				}
