{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 46.0, 93.0, 1113.0, 717.0 ],
		"bglocked" : 0,
		"defrect" : [ 46.0, 93.0, 1113.0, 717.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 268.0, 4.0, 77.0, 18.0 ],
					"id" : "obj-25"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 816.0, 24.0, 111.0, 18.0 ],
					"id" : "obj-24"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 364.0, 552.0, 61.0, 20.0 ],
					"id" : "obj-19"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 852.0, 548.0, 61.0, 20.0 ],
					"id" : "obj-5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 680.0, 536.0, 61.0, 20.0 ],
					"id" : "obj-8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 80.0, 544.0, 900.0, 15.0 ],
					"id" : "obj-7",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 160.0, 24.0, 89.0, 18.0 ],
					"id" : "obj-3"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "addFunction something2",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 108.0, 4.0, 142.0, 18.0 ],
					"id" : "obj-2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 80.0, 30.0, 50.0, 18.0 ],
					"id" : "obj-23"
				}
