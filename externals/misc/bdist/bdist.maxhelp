{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 268.0, 44.0, 861.0, 585.0 ],
		"bgcolor" : [ 0.42, 0.46, 0.7, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 268.0, 44.0, 861.0, 585.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"hidden" : 1,
					"patching_rect" : [ 325.0, 159.0, 76.0, 20.0 ],
					"numoutlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"hidden" : 1,
					"patching_rect" : [ 42.0, 554.0, 343.0, 32.0 ],
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-126",
					"numinlets" : 1,
					"patching_rect" : [ 42.0, 513.0, 299.0, 28.0 ],
					"numoutlets" : 4,
					"handoff" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"embed" : 1,
					"patching_rect" : [ 44.0, 461.0, 109.0, 48.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 162.0, 481.0, 131.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 42.0, 514.0, 294.0, 27.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0
				}
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"presentation_rect" : [ 524.0, 507.0, 0.0, 0.0 ],
					"id" : "obj-123",
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 524.0, 507.0, 269.0, 34.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"linecount" : 6,
					"presentation_rect" : [ 524.0, 409.0, 0.0, 0.0 ],
					"id" : "obj-122",
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 524.0, 409.0, 272.0, 89.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"presentation_rect" : [ 524.0, 352.0, 0.0, 0.0 ],
					"id" : "obj-121",
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 524.0, 352.0, 257.0, 48.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"linecount" : 6,
					"presentation_rect" : [ 485.0, 256.0, 0.0, 0.0 ],
					"id" : "obj-120",
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 524.0, 250.0, 252.0, 89.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "a",
					"presentation_rect" : [ 260.0, 190.0, 0.0, 0.0 ],
					"id" : "obj-116",
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"minimum" : 0.0,
					"presentation_rect" : [ 210.0, 190.0, 0.0, 0.0 ],
					"id" : "obj-117",
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"presentation_rect" : [ 604.0, 331.0, 0.0, 0.0 ],
					"id" : "obj-111",
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 525.0, 176.0, 243.0, 62.0 ],
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numoutlets" : 0,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"presentation_rect" : [ 129.0, 128.0, 0.0, 0.0 ],
					"id" : "obj-109",
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 71.0, 47.0, 415.0, 39.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"presentation_rect" : [ 19.0, 110.0, 0.0, 0.0 ],
					"id" : "obj-107",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"presentation_rect" : [ 19.0, 2.0, 0.0, 0.0 ],
					"id" : "obj-108",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"presentation_rect" : [ 883.0, 159.0, 0.0, 0.0 ],
					"id" : "obj-105",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"presentation_rect" : [ 367.0, 142.0, 0.0, 0.0 ],
					"id" : "obj-106",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"presentation_rect" : [ 512.0, 23.0, 0.0, 0.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"presentation_rect" : [ -4.0, 6.0, 0.0, 0.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 48.0, 332.0, 116.0, 20.0 ],
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"outlettype" : [ "float", "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 3,
					"patching_rect" : [ 48.0, 184.0, 404.0, 142.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 51.5, 547.0, 51.5, 547.0 ]
				}
