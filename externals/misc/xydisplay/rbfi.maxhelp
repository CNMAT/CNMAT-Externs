{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 936.0, 240.0, 20.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"id" : "obj-36",
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"patching_rect" : [ 936.0, 276.0, 117.0, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"id" : "obj-15",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"fontname" : "Arial",
					"patching_rect" : [ 724.0, 188.0, 50.0, 20.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"fontname" : "Arial",
					"patching_rect" : [ 668.0, 188.0, 50.0, 20.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"fontsize" : 12.0,
					"id" : "obj-34",
...
, 			{
				"box" : 				{
					...
					"text" : "pak 0.05 0.1",
					"fontname" : "Arial",
					"patching_rect" : [ 668.0, 216.0, 77.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"id" : "obj-35",
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"patching_rect" : [ 668.0, 240.0, 183.0, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"id" : "obj-11",
