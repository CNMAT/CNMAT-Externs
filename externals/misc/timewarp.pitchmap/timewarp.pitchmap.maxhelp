...
, 			{
				"box" : 				{
					...
					"text" : "* 1000.",
					"numoutlets" : 1,
					"patching_rect" : [ 192.0, 728.0, 49.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"outlettype" : [ "float" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "pack 0. 0. 0.",
					"numoutlets" : 1,
					"patching_rect" : [ 72.0, 768.0, 76.0, 20.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "noteout",
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 824.0, 51.0, 20.0 ],
					"id" : "obj-8",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 3
...
, 			{
				"box" : 				{
					...
					"text" : "t f b b",
					"numoutlets" : 3,
					"patching_rect" : [ 72.0, 648.0, 46.0, 20.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "zl iter 1",
					"numoutlets" : 2,
					"patching_rect" : [ 72.0, 624.0, 49.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "zl queue",
					"numoutlets" : 2,
					"patching_rect" : [ 200.0, 688.0, 56.0, 20.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "zl queue",
					"numoutlets" : 2,
					"patching_rect" : [ 136.0, 688.0, 56.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "makenote",
					"numoutlets" : 2,
					"patching_rect" : [ 72.0, 800.0, 63.0, 20.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"patching_rect" : [ 72.0, 584.0, 197.0, 20.0 ],
					"id" : "obj-4",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "print TOcellblock",
					"numoutlets" : 0,
					"patching_rect" : [ 472.0, 432.0, 99.0, 20.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 472.0, 400.0, 87.0, 20.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 568.0, 400.0, 119.0, 20.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
