	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 368.0, 320.0, 46.0, 20.0 ],
					"id" : "obj-49"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 288.0, 552.0, 20.0, 20.0 ],
					"id" : "obj-48"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 368.0, 296.0, 20.0, 20.0 ],
					"id" : "obj-46"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.0, 536.0, 27.0, 20.0 ],
					"id" : "obj-44"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 344.0, 488.0, 32.5, 20.0 ],
					"id" : "obj-43"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 344.0, 392.0, 54.0, 20.0 ],
					"id" : "obj-42"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 344.0, 464.0, 61.0, 20.0 ],
					"id" : "obj-39"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 5,
					"presentation_rect" : [ 341.0, 432.0, 0.0, 0.0 ],
					"numoutlets" : 4,
					"fontname" : "Arial",
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 344.0, 432.0, 73.0, 20.0 ],
					"id" : "obj-40"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"numinlets" : 1,
					"presentation_rect" : [ 338.0, 433.0, 0.0, 0.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"presentation_rect" : [ 339.0, 579.0, 0.0, 0.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 96.0, 464.0, 54.0, 20.0 ],
					"id" : "obj-34"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 5,
					"presentation_rect" : [ 339.0, 547.0, 0.0, 0.0 ],
					"numoutlets" : 4,
					"fontname" : "Arial",
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 96.0, 432.0, 73.0, 20.0 ],
					"id" : "obj-35"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"presentation_rect" : [ 339.0, 467.0, 0.0, 0.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 96.0, 352.0, 38.0, 20.0 ],
					"id" : "obj-36"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 353.5, 574.0, 458.0, 574.0, 458.0, 364.0, 388.5, 364.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-42", 0 ],
					"hidden" : 0,
					"midpoints" : [ 367.0, 519.0, 320.0, 519.0, 320.0, 374.0, 353.5, 374.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 105.5, 497.0, 185.0, 497.0, 185.0, 342.0, 124.5, 342.0 ]
				}
