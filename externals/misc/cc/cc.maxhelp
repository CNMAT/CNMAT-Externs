...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cc @inlets 2 @outlets 2 @load /Users/johnmac/bloo_build/bloo.dylib @maxsdk /Users/johnmac/Development/cnmat/trunk/max/SDK/MaxSDK-5",
					"linecount" : 2,
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 404.0, 312.0, 434.0, 34.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 404.0, 256.0, 536.0, 20.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ]
				}
