{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 284.0, 44.0, 1141.0, 899.0 ],
		"bglocked" : 0,
		"defrect" : [ 284.0, 44.0, 1141.0, 899.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 190.0, 85.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "list", "", "", "" ],
					"cols" : 1,
					"patching_rect" : [ 560.0, 570.0, 200.0, 200.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 750.0, 400.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "list", "", "", "" ],
					"cols" : 1,
					"patching_rect" : [ 770.0, 570.0, 200.0, 200.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 770.0, 430.0, 120.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 920.0, 460.0, 145.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 770.0, 460.0, 145.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 770.0, 510.0, 128.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/foo -32, /b*r 99., /black/flag 3. -5. 7., /lamb/?f/god 4. 8., bang",
					"id" : "obj-4",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 220.0, 334.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.op /foo abs /foobar /bar / 2. /black/flag map 0. 10. 0. 1. /circle/jerks /lamb/of/god !/ 5. /rotten/sound",
					"id" : "obj-1",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"patching_rect" : [ 80.0, 300.0, 538.0, 20.0 ]
				}
