...
** Bugs Fixed
*** o.expr
**** FIXED a crash in cumsum that would often happen when interacting with the list manipulation tab of the help file

* VERSION 1.0.3b
Released: [2012-03-31 Sat]
** Bugs Fixed
*** o.expr
**** FIXED clip now works as expected

* VERSION 1.0.2b
Released: [2012-03-28 Wed]
** Bugs Fixed
*** o.var
**** FIXED Bundles in the left inlet were not being stored
*** o.expr
**** FIXED Bundles of length 0 will not cause a crash
