...
,
					"patching_rect" : [ 245.0, 185.0, 125.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"digest" : "",
						"default_fontname" : "Arial",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 305.0, 108.0, 111.0, 48.0 ],
									"text" : "/mysynth/*/freq $1\n/mysynth/*/gain .5\n/nada rien",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
,
					"patching_rect" : [ 30.0, 185.0, 59.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"digest" : "",
						"default_fontname" : "Arial",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 280.0, 120.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 112.0, 280.0, 121.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "FullPacket" ],
									"patching_rect" : [ 160.0, 221.0, 225.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 280.0, 78.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 280.0, 108.0, 111.0, 48.0 ],
									"text" : "/mysynth/*/freq $1\n/mysynth/*/gain .5\n/nada rien",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 160.0, 108.0, 111.0, 48.0 ],
...
,
					"patching_rect" : [ 171.0, 185.0, 62.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"digest" : "",
						"default_fontname" : "Arial",
