...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /foo = /foo + PI",
					"patching_rect" : [ 408.0, 272.0, 126.0, 20.0 ],
					"id" : "obj-45",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /foo = /foo + 2",
					"patching_rect" : [ 408.0, 184.0, 121.0, 20.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 208.0, 472.0, 142.0, 34.0 ],
					"id" : "obj-42",
					"fontname" : "Arial",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /bar = /foo[[4\\,5\\,6]]",
					"patching_rect" : [ 208.0, 448.0, 148.0, 20.0 ],
					"id" : "obj-40",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /oddi = range(1\\, length(/foo)\\, 2)",
					"patching_rect" : [ 616.0, 464.0, 220.0, 20.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /eveni = range(0\\, length(/foo)\\, 2)",
					"patching_rect" : [ 616.0, 440.0, 226.0, 20.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 5,
					"patching_rect" : [ 616.0, 544.0, 201.0, 75.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /foo = range(0\\, 10)",
					"patching_rect" : [ 616.0, 416.0, 150.0, 20.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /odd = /foo[[/oddi]]",
					"patching_rect" : [ 616.0, 512.0, 144.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /even = /foo[[/eveni]]",
					"patching_rect" : [ 616.0, 488.0, 156.0, 20.0 ],
					"id" : "obj-23",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /2nd = /foo[[1]]",
					"patching_rect" : [ 64.0, 448.0, 124.0, 20.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.expr /foo = 2 + 2",
					"patching_rect" : [ 64.0, 184.0, 108.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 64.0, 784.0, 519.0, 20.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
