...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 375.0, 159.0, 49.0, 20.0 ],
					"text" : "route 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 343.0, 367.0, 73.0, 20.0 ],
					"text" : "o.difference"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 351.0, 101.0, 32.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 131.0, 27.0, 20.0 ],
					"text" : "iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 239.0, 287.0, 82.0, 20.0 ],
					"text" : "o.intersection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 351.0, 77.0, 74.0, 20.0 ],
					"text" : "patcherargs"
				}
