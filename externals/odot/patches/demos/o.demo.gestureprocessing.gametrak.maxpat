{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 311.0, 44.0, 1017.0, 782.0 ],
		"bglocked" : 0,
		"defrect" : [ 311.0, 44.0, 1017.0, 782.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"args" : [ "/left/z", "/right/z" ],
					"patching_rect" : [ 96.0, 214.0, 253.0, 43.0 ],
					"id" : "obj-3",
					"numinlets" : 1,
					"name" : "o.multislider.maxpat",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 125.0, 91.0, 89.0 ],
					"id" : "obj-29",
					"fontname" : "Arial",
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 20.0, 262.0, 116.0, 20.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 881.0, 433.0, 583.0, 247.0 ],
						"bglocked" : 0,
						"defrect" : [ 881.0, 433.0, 583.0, 247.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 99.0, 287.0, 173.0, 20.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "o.multislider /pluck/upper/threshhold 0. 0.2 /pluck/lower/threshhold 0. -0.2",
									"fontsize" : 12.0,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 6.0, 77.0, 399.0, 20.0 ],
									"id" : "obj-4",
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 101.0, 356.0, 50.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "o.multislider /left/radius /left/pluck -1. 1. @setstyle 2",
									"fontsize" : 12.0,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 5.0, 39.0, 284.0, 20.0 ],
									"id" : "obj-11",
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 46.0, 93.0, 20.0 ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 314.0, 99.0, 20.0 ],
					"id" : "obj-51",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 3,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 899.0, 85.0, 867.0, 777.0 ],
						"bglocked" : 0,
						"defrect" : [ 899.0, 85.0, 867.0, 777.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 20.0, 230.0, 47.0, 20.0 ],
					"id" : "obj-46",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 75.0, 119.0, 423.0, 130.0 ],
						"bglocked" : 0,
						"defrect" : [ 75.0, 119.0, 423.0, 130.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 65.0, 351.0, 20.0, 20.0 ],
					"id" : "obj-42",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 20.0, 353.0, 20.0, 20.0 ],
					"id" : "obj-40",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "o.show",
					"fontsize" : 12.0,
					"patching_rect" : [ 744.0, 421.0, 49.0, 20.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 19.0, 205.0, 69.0, 20.0 ],
					"id" : "obj-32",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 19.0, 134.0, 75.0, 20.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 19.0, 87.0, 58.0, 20.0 ],
					"id" : "obj-23",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
