{
	"patcher" : 	{
		...
		"bglocked" : 0,
		"defrect" : [ 116.0, 44.0, 804.0, 364.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 340.0, 210.0, 83.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "o.message",
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 240.0, 65.0, 20.0 ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 430.0, 210.0, 196.0, 34.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.0, 210.0, 161.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.print",
					"patching_rect" : [ 60.0, 240.0, 44.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.print",
					"patching_rect" : [ 60.0, 140.0, 44.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 110.0, 50.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.0, 130.0, 303.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.0, 110.0, 303.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "/foo 1 2 3",
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 110.0, 59.0, 20.0 ],
					"fontsize" : 12.0,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
