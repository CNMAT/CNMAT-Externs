	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "printit",
					"fontsize" : 12.0,
					"presentation_rect" : [ 115.0, 349.0, 0.0, 0.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "o.message",
					"text" : "/JpbQpzLLcZdEBUPRXm/ 73870 YEqFfcmbWaCPAvnPUQg RK xRXBZtmxAZWFXJAmpC 0.270403 19096 \n/a gioC -0.839467 ",
					"linecount" : 3,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 36.0, 550.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 804.0, 544.0, 40.0, 20.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "o.message",
					"text" : "/rotten/sound/murderworks 2002 \n/rotten/sound/exit 2005 ",
					"linecount" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
