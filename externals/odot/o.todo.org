...
**** TODO Build documentation system that produces OSC bundles containing all info about objects
**** STARTED Get rid of skunky code in libomax and refactor lib.  
Get all objects up to date with the right functions from this lib
*** o.expr
