	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "set 1 /bar",
					"patching_rect" : [ 420.0, 170.0, 61.0, 18.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 497.0, 169.0, 0.0, 0.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/foo 10",
					"patching_rect" : [ 550.0, 230.0, 50.0, 18.0 ],
					"id" : "obj-29",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 546.0, 230.0, 0.0, 0.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/bar 20",
					"patching_rect" : [ 570.0, 170.0, 48.0, 18.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 570.0, 257.0, 0.0, 0.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/foo 10",
					"patching_rect" : [ 570.0, 150.0, 47.0, 18.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 572.0, 230.0, 0.0, 0.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "20",
					"patching_rect" : [ 480.0, 230.0, 50.0, 18.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "set 1 /foo",
					"patching_rect" : [ 480.0, 150.0, 60.0, 18.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.route /bar",
					"patching_rect" : [ 480.0, 200.0, 72.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"presentation_rect" : [ 478.0, 273.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"presentation_rect" : [ 39.0, 269.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Setting the \"bundle_partial_matches\" attribute to 0 will cause partial matches to come out as max messages.",
					"linecount" : 2,
					"patching_rect" : [ 550.0, 70.0, 315.0, 34.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"presentation_rect" : [ 552.0, 95.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "o.message",
					"text" : "/foo/bar 23",
					"patching_rect" : [ 480.0, 70.0, 66.0, 20.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					...
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"presentation_rect" : [ 479.0, 81.0, 0.0, 0.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "o.route /foo @bundle_partial_matches 0",
					"patching_rect" : [ 480.0, 110.0, 224.0, 20.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
