...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"outlettype" : [ "" ],
									"patching_rect" : [ 311.0, 148.0, 138.0, 48.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-11",
									"fontname" : "Arial",
									"patching_rect" : [ 277.0, 275.0, 154.0, 34.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"outlettype" : [ "" ],
									"patching_rect" : [ 197.0, 275.0, 69.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										...
										"bglocked" : 0,
										"defrect" : [ 93.0, 110.0, 532.0, 577.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"outlettype" : [ "" ],
									"patching_rect" : [ 285.0, 128.0, 111.0, 62.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 109.0, 65.0, 578.0, 533.0 ],
						"bglocked" : 0,
						"defrect" : [ 109.0, 65.0, 578.0, 533.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-32",
									"fontname" : "Arial",
									"patching_rect" : [ 160.0, 85.0, 240.0, 48.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"outlettype" : [ "" ],
									"patching_rect" : [ 265.0, 355.0, 120.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"outlettype" : [ "" ],
									"patching_rect" : [ 112.0, 355.0, 121.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 295.0, 153.0, 50.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"outlettype" : [ "" ],
									"patching_rect" : [ 295.0, 183.0, 120.0, 48.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"outlettype" : [ "" ],
									"patching_rect" : [ 160.0, 183.0, 122.0, 48.0 ]
								}
