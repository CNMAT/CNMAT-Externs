...
void wiiremote_init(WiiRemoteRef wiiremote)
{
	...
	wiiremote->calibrate = 0;
	
	wiiremote->wiiBalanceBoardCalibData.tr_zero_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tr_zero_2 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.br_zero_1 =  0x10;		
	wiiremote->wiiBalanceBoardCalibData.br_zero_2 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tl_zero_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tl_zero_2 =  0x10;		
	wiiremote->wiiBalanceBoardCalibData.bl_zero_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.bl_zero_2 =  0x10;
	
	wiiremote->wiiBalanceBoardCalibData.tr_17_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tr_17_2 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.br_17_1 =  0x10;	
	wiiremote->wiiBalanceBoardCalibData.br_17_2 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tl_17_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tl_17_2 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.bl_17_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.bl_17_2 =  0x10;
	
	wiiremote->wiiBalanceBoardCalibData.tr_34_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tr_34_2 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.br_34_1 =  0x10;		
	wiiremote->wiiBalanceBoardCalibData.br_34_2 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tl_34_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.tl_34_2 =  0x10;		
	wiiremote->wiiBalanceBoardCalibData.bl_34_1 =  0x10;
	wiiremote->wiiBalanceBoardCalibData.bl_34_2 =  0x10;
	
	wiiremote->wiiBalanceBoardCalibData2.TR[0] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.TR[1] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.TR[2] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.BR[0] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.BR[1] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.BR[2] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.TL[0] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.TL[1] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.TL[2] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.BL[0] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.BL[1] = 0x10;
	wiiremote->wiiBalanceBoardCalibData2.BL[2] = 0x10;	
	
	wiiremote->interpolationFactor = 17.0;
}

//KJS
Boolean setInterpolationFactor(WiiRemoteRef wiiremote, long value)
{
	wiiremote->interpolationFactor = value;
}
float getBalanceBoardSensorValue(WiiRemoteRef wiiremote, short sensor, short min, short mid, short max)
{
	float value = wiiremote->interpolationFactor;
	if(max == mid || mid == min)
		return 0;
	
	if( sensor < mid )
		return value * ((float)(sensor - min) / (mid - min));
	else
		return value * ((float)(sensor - mid) / (max - mid)) + value;
}
...
void checkDevice(WiiRemoteRef wiiremote, IOBluetoothDeviceRef device)
{
	...
	{
		if (CFStringCompare(name, CFSTR("Nintendo RVL-CNT-01"), 0) == kCFCompareEqualTo || CFStringCompare(name, CFSTR("Nintendo RVL-WBC-01"), 0) == kCFCompareEqualTo)
		{
...
void handleRAMData(WiiRemoteRef wiiremote, unsigned char *dp, size_t dataLength)
{
	...
	if ((dp[5] == 0x00) && (dp[6] == 0xF0))
	{
		...
		if (decrypt(dp[21]) == 0x2E || decrypt(dp[21]) == 0xFF)
		{
			wiiremote->expType = WiiExpNotAttached;
		}
		//KJS
		else
		if( decrypt(dp[21]) == 0x2A)
		{
			wiiremote->expType = WiiBalanceBoard;
		}
	...
	//if (dp[6] == 0x24) //test
	//{
	if (wiiremote->expType == WiiBalanceBoard)
	{
		//KJS. Dec. 3. 2008
		if (wiiremote->calibrate==1)
		{
			for (k = 0; k < 16; k++)
				wiiremote->calibration_data[k] = dp[7+k];
			wiiremote->calibrate=2;
		}
		if (wiiremote->calibrate==3)
		{
			for (k = 0; k < 8; k++)
			wiiremote->calibration_data[k+16] = dp[7+k];
			
			wiiremote->wiiBalanceBoardCalibData2.TR[0] = (short) ((short) (wiiremote->calibration_data[0]) << 8 | (wiiremote->calibration_data[1])) ;
			wiiremote->wiiBalanceBoardCalibData2.BR[0] = (short) ((short) (wiiremote->calibration_data[2]) << 8 | (wiiremote->calibration_data[3])) ;
			wiiremote->wiiBalanceBoardCalibData2.TL[0] = (short) ((short) (wiiremote->calibration_data[4]) << 8 | (wiiremote->calibration_data[5])) ;
			wiiremote->wiiBalanceBoardCalibData2.BL[0] = (short) ((short) (wiiremote->calibration_data[6]) << 8 | (wiiremote->calibration_data[7])) ;

			wiiremote->wiiBalanceBoardCalibData2.TR[1] = (short) ((short) (wiiremote->calibration_data[8]) << 8 | (wiiremote->calibration_data[9])) ;
			wiiremote->wiiBalanceBoardCalibData2.BR[1] = (short) ((short) (wiiremote->calibration_data[10]) << 8 | (wiiremote->calibration_data[11])) ;
			wiiremote->wiiBalanceBoardCalibData2.TL[1] = (short) ((short) (wiiremote->calibration_data[12]) << 8 | (wiiremote->calibration_data[13])) ;
			wiiremote->wiiBalanceBoardCalibData2.BL[1] = (short) ((short) (wiiremote->calibration_data[14]) << 8 | (wiiremote->calibration_data[15])) ;
			
			wiiremote->wiiBalanceBoardCalibData2.TR[2] = (short) ((short) (wiiremote->calibration_data[16]) << 8 | (wiiremote->calibration_data[17])) ;
			wiiremote->wiiBalanceBoardCalibData2.BR[2] = (short) ((short) (wiiremote->calibration_data[18]) << 8 | (wiiremote->calibration_data[19])) ;
			wiiremote->wiiBalanceBoardCalibData2.TL[2] = (short) ((short) (wiiremote->calibration_data[20]) << 8 | (wiiremote->calibration_data[21])) ;
			wiiremote->wiiBalanceBoardCalibData2.BL[2] = (short) ((short) (wiiremote->calibration_data[22]) << 8 | (wiiremote->calibration_data[23])) ;			
		}
	}
	//}
	...
	if (wiiremote->calibrate==2)
		wiiremote_expansion(wiiremote, wiiremote->isExpansionPortEnabled);
}
...
void handleExtensionData(WiiRemoteRef wiiremote, unsigned char *dp, size_t dataLength)
{
	...
	else if (wiiremote->expType == WiiClassicController)
	{
	...
	else if (wiiremote->expType == WiiBalanceBoard)		
	{
		wiiremote->raw[0] = dp[startByte+0];
		wiiremote->raw[1] = dp[startByte+1];
		wiiremote->raw[2] = dp[startByte+2];
		wiiremote->raw[3] = dp[startByte+3];
		wiiremote->raw[4] = dp[startByte+4];
		wiiremote->raw[5] = dp[startByte+5];
		wiiremote->raw[6] = dp[startByte+6];
		wiiremote->raw[7] = dp[startByte+7];
		
		//KJS		
		wiiremote->raw_data[0] = (short) ((short)dp[startByte+0] << 8 | dp[startByte+ 1]);  //TR
		wiiremote->raw_data[1] = (short) ((short)dp[startByte+2] << 8 | dp[startByte+ 3]);  //BR
		wiiremote->raw_data[2] = (short) ((short)dp[startByte+4] << 8 | dp[startByte+ 5]);  //TL
		wiiremote->raw_data[3] = (short) ((short)dp[startByte+6] << 8 | dp[startByte+ 7]);  //BL
		
		//calibrated data - KG
		wiiremote->kg_data[0] = getBalanceBoardSensorValue(wiiremote, wiiremote->raw_data[0], wiiremote->wiiBalanceBoardCalibData2.TR[0], wiiremote->wiiBalanceBoardCalibData2.TR[1], wiiremote->wiiBalanceBoardCalibData2.TR[2]);
		wiiremote->kg_data[1] = getBalanceBoardSensorValue(wiiremote, wiiremote->raw_data[1], wiiremote->wiiBalanceBoardCalibData2.BR[0], wiiremote->wiiBalanceBoardCalibData2.BR[1], wiiremote->wiiBalanceBoardCalibData2.BR[2]);
		wiiremote->kg_data[2] = getBalanceBoardSensorValue(wiiremote, wiiremote->raw_data[2], wiiremote->wiiBalanceBoardCalibData2.TL[0], wiiremote->wiiBalanceBoardCalibData2.TL[1], wiiremote->wiiBalanceBoardCalibData2.TL[2]);
		wiiremote->kg_data[3] = getBalanceBoardSensorValue(wiiremote, wiiremote->raw_data[3], wiiremote->wiiBalanceBoardCalibData2.BL[0], wiiremote->wiiBalanceBoardCalibData2.BL[1], wiiremote->wiiBalanceBoardCalibData2.BL[2]);
		
		//calibrated data - LB
		wiiremote->lb_data[0] = wiiremote->kg_data[0] * KG2LB;
		wiiremote->lb_data[1] = wiiremote->kg_data[1] * KG2LB;
		wiiremote->lb_data[2] = wiiremote->kg_data[2] * KG2LB;
		wiiremote->lb_data[3] = wiiremote->kg_data[3] * KG2LB;
		
		wiiremote->weightKG = wiiremote->kg_data[0] + wiiremote->kg_data[1] + wiiremote->kg_data[2] + wiiremote->kg_data[3]; 
		wiiremote->weightLB = wiiremote->lb_data[0] + wiiremote->lb_data[1] + wiiremote->lb_data[2] + wiiremote->lb_data[3]; 
		
		//by ICO
		if(wiiremote->weightKG > 1)
		{
			wiiremote->centerGravity_x = ((((wiiremote->kg_data[0]/*TR*/ + wiiremote->kg_data[1]/*BR*/) - wiiremote->weightKG) / wiiremote->weightKG ) * 2 ) + 1;
			wiiremote->centerGravity_y = ((((wiiremote->kg_data[2]/*TL*/ + wiiremote->kg_data[0]/*TR*/) - wiiremote->weightKG) / wiiremote->weightKG ) * 2 ) + 1;
		}
		else
		{
			wiiremote->centerGravity_x = 0;
			wiiremote->centerGravity_x = 0;
		}
	}
}
...
{	
	...
	else
	{
		//KJS
		if (wiiremote->expType == WiiBalanceBoard) {
			if (wiiremote->calibrate==0) {
				readData(wiiremote, 0x04a40024, 16); // get calib data
				wiiremote->calibrate=1;
			}
			if (wiiremote->calibrate==2) {
				readData(wiiremote, 0x04a40034, 16); // get calib data
				wiiremote->calibrate=3;
			}
		}
		else
			readData(wiiremote, 0x04A40020, 16); // get calib data
	}
